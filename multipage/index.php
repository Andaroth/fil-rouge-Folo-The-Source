...
<body>
  ...
  <div class="row">
    ...
    <div class="row purple darken-4 pt-25 pb-25 mb-0 orange-text">
      <div class="container">
        <div class="col s6">
          <img src="./img/well.jpg" class="responsive-img" alt="We need water">
        </div>
        <div class="col s6">
          <h2>What we do</h2>
    ...
    <div class="row orange darken-3 pt-25 pb-25 mb-0">
      <div class="container">
        ...
        <div class="col s12 l3">
          <div class="card">
            <div class="card-image homepcard">
              <img src="./img/hexagon.jpg" alt="The Hexagon">
            </div>
        ...
        <div class="col s12 l3">
          <div class="card">
            <div class="card-image homepcard">
              <img src="./img/sold_out.jpg" alt="Wedgewood Rooms">
            </div>
            <div class="card-stacked">
              <div class="card-content">
        ...
        <div class="col s12 l3">
          <div class="card">
            <div class="card-image homepcard">
              <img src="./img/yum.jpg" alt="The Junction">
            </div>
            <div class="card-stacked">
              <div class="card-content">
        ...
        <div class="col s12 l3">
          <div class="card">
            <div class="card-image homepcard">
              <img src="./img/glasgow.jpg" alt="The Glasgow Royal Concert Hall">
            </div>
            <div class="card-stacked">
              <div class="card-content">
    ...
    <div class="row multimedia">
        ...
        <div class="row">
          <div class="card">
            <div class="card-image">
              <img height="300" src="./img/needwater.jpg" alt="people needs water">
      ...
      <div class="col s12 m4">
        <div class="row">
          <div class="card">
            <div class="card-image">
              <img height="300" src="./img/nfalykouyate.jpg" alt="nfalykouyate singer">
      ...
      <div class="col s12 m4">
        <div class="row">
          <div class="card">
            <div class="card-image">
              <img height="300" src="./img/inauguration.jpg" alt="well's inauguration">
