...
<div class="orange darken-4">
  ...
  <div class="col s12 m7">
    <div class="card horizontal">
      <div class="card-image">
        <img src="./img/hexagon.jpg" alt="The Hexagon" style="width: 270px">
      </div>
  ...
  <div class="col s12 m7">
    <div class="card horizontal">
      <div class="card-image">
        <img src="./img/sold_out.jpg" alt="Wedgewood Rooms" style="width: 270px">
      </div>
      <div class="card-stacked">
        <div class="card-content">
  ...
  <div class="col s12 m7">
    <div class="card horizontal">
      <div class="card-image">
        <img src="./img/yum.jpg" alt="The Junction" style="width: 270px">
      </div>
      <div class="card-stacked">
        <div class="card-content">
   ...
   <div class="col s12 m7">
    <div class="card horizontal">
      <div class="card-image">
        <img src="./img/glasgow.jpg" alt="The Glasgow Royal Concert Hall" style="width: 270px">
      </div>
      <div class="card-stacked">
        <div class="card-content">
  ...
  <div class="col s12 m7">
    <div class="card horizontal">
      <div class="card-image">
        <img src="./img/palm.jpeg" alt="Palm Camayenne" style="width: 270px">
      </div>
      <div class="card-stacked">
        <div class="card-content">
  ...
  <div class="col s12 m7">
    <div class="card horizontal">
      <div class="card-image">
        <img src="./img/arcadia.jpg" alt="Arcadia Stage" style="width: 270px">
      </div>
      <div class="card-stacked">
        <div class="card-content">
  ...
  <div class="col s12 m7">
    <div class="card horizontal">
      <div class="card-image">
        <img src="./img/guine.jpg" alt="Festival des Arts Africains" style="width: 270px">
      </div>
      <div class="card-stacked">
        <div class="card-content">
