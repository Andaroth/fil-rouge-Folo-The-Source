...
<div class="orange darken-4">
	<div class="container">
      ...
      <div class="col s12 m7">
        <div class="card horizontal">
          <div class="card-image">
            <img src="./img/hexagon.jpg" class="mw-270" alt="The Hexagon">
          </div>
      ...
      <div class="col s12 m7">
        <div class="card horizontal">
          <div class="card-image">
            <img src="./img/sold_out.jpg" class="mw-270" alt="Wedgewood Rooms">
          </div>
          <div class="card-stacked">
            <div class="card-content">
      ...
      <div class="col s12 m7">
        <div class="card horizontal">
          <div class="card-image">
            <img src="./img/yum.jpg" class="mw-270" alt="The Junction">
          </div>
          <div class="card-stacked">
            <div class="card-content">
       ...
       <div class="col s12 m7">
        <div class="card horizontal">
          <div class="card-image">
            <img src="./img/glasgow.jpg" class="mw-270" alt="The Glasgow Royal Concert Hall">
          </div>
          <div class="card-stacked">
            <div class="card-content">
      ...
      <div class="col s12 m7">
        <div class="card horizontal">
          <div class="card-image">
            <img src="./img/palm.jpeg" class="mw-270" alt="Palm Camayenne">
          </div>
          <div class="card-stacked">
            <div class="card-content">
      ...
      <div class="col s12 m7">
        <div class="card horizontal">
          <div class="card-image">
            <img src="./img/arcadia.jpg" class="mw-270" alt="Arcadia Stage">
          </div>
          <div class="card-stacked">
            <div class="card-content">
      ...
      <div class="col s12 m7">
        <div class="card horizontal">
          <div class="card-image">
            <img src="./img/guine.jpg" class="mw-270" alt="Festival des Arts Africains">
          </div>
          <div class="card-stacked">
            <div class="card-content">
